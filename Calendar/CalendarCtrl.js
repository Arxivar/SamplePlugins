        ...
        var initCalendar = function() {
            ...
            $('#calendar').fullCalendar({
                ...
                resources: function(callback) {
                    var resurces = _.map(_.filter($scope.users, { 'selected': true }), function(user) { return { id: user.user.toString(), title: user.description }; });
                    callback(resurces);
                },
                eventClick: function (calEvent, jsEvent, view) {
                    $uibModal.open({
                        ...
                        template: '<div class="inmodal"><div class="modal-header"><i class="fa fa-chain"></i> <strong>Informazioni sull\'evento</strong></div><div class="modal-body"><br/>' +
                            ...
                            '<strong>Da: </strong><span>{{event.start | utcDateAndTime}}</span><br/>' +
                        '<strong>A: </strong><span>{{event.end | utcDateAndTime}}</span><br/>' +
                        ...
                        controller: ['$scope', '$uibModalInstance', 'downloadFileService', function ($scope, $uibModalInstance, downloadFileService) {
