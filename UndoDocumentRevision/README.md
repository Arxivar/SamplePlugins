...
* In order to install this plugin in ARXivar Next, just put the plugin folder (`UndoDocumentRevision`) in your plugin installation folder (e.g. `MyDrive:\Program Files (x86)\Able Tech S.r.l\ARXivarNext WebPortal\Scripts\plugins`)
