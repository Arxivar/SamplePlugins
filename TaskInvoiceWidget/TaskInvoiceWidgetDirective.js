function initMap(lat, lng) {
	if (lat !== undefined && google !== undefined) {
...
angular.module('arxivar.plugins.directives').directive('taskinvoicewidgetdirective', [
	'TaskInvoiceWidget', 'pluginService', 'taskVariablesService', 'taskOperationsService', '_', 'moment', '$http',
	function(TaskInvoiceWidget, pluginService, taskVariablesService, taskOperationsService, _, moment, $http) {
		...
		return {
			...
			link: function(scope, element, attrs, ctrls) {
				const _settVariables = ({
					...
					// $http.get('https://maps.googleapis.com/maps/api/geocode/json?address=' + scope.indirizzo)
